...
import { deletePizza, deletePizzas } from '../../redux/actions/cart';
import { addPizza } from './../../redux/actions/cart';




const PizzaBlock = ({id, size, type, quantity, imageUrl, name, price}) => {
    ...
    const onDeletePizzas = () => {
        dispatch(deletePizzas(id))
    }

    return (
        <div className="shopping__pizza selected-pizza">
            <div className="selected-pizza__content">
                <img src={imageUrl} alt="" className="selected-pizza__img-pizza" />
                <div className="selected-pizza__text">
                    <div className="selected-pizza__title">{name}</div>
                    <div className="selected-pizza__subtitle">{pizzaTypes[type]} тесто, {size} см.</div>
                </div>
            </div>
            <div className="selected-pizza__settings">
                <div className="selected-pizza__selected-quantity">
                    <svg onClick={onDeletePizza} width="32" height="32" viewBox="0 0 32 32" fill="#FE5F1E" stroke="#FE5F1E" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span>{quantity}</span>
                    <svg onClick={onAddPizza} width="32" height="32" viewBox="0 0 32 32" stroke="#FE5F1E" fill="#EB5A1E" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="16" cy="16" r="15" fill="white" strokeWidth="2" />
                ...
                <span className='selected-pizza__cost'>{price} ₴</span>
                <div className='selected-pizza__dagger'>
                    <svg onClick={onDeletePizzas} width="32" height="32" viewBox="0 0 32 32" fill="#D0D0D0" stroke="#D7D7D7" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="16" cy="16" r="15" fill="none" strokeWidth="2" />
